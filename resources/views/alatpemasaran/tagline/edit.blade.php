        ...
        <div class="col-md-12">
             <div class="px-3">
                <div class="card-header row" style="border: 1px solid black !important;">
                    <div class="col-md-12">
                        <span class="float-left">Tagline Perusahaan</span>
        ...
        <div class="col-md-12  mt-5">
           <div class="card">
              <div class="card-header bg-primary">
                 <h6 class="text-white">Edit Tagline Perusahaan  </h6>
              </div>
              <div class="card-body">
                 <form method="post" action="{{url('update-tagline')}}" enctype="multipart/form-data" id="submitdata">
                    @method('patch')
                    @csrf

                     <div class="form-group">
                       <label>Judul Tagline</label>
                       <input type="text" value="{{$ft->judul}}" name="judul" id="" class="form-control"/>
