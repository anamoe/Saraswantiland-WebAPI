        ...
        <div class="col-md-12">
             <div class="px-3">
                <div class="card-header row" style="border: 1px solid black !important;">
                    <div class="col-md-12">
                        <span class="float-left">Filosofi Perusahaan</span>
        ...
        <div class="col-md-12  mt-5">
           <div class="card">
              <div class="card-header bg-primary">
                 <h6 class="text-white">Edit FilosofiPerusahaan </h6>
              </div>
              <div class="card-body">
                 <form method="post" action="{{url('update-filosofi')}}" enctype="multipart/form-data" id="submitdata">
                    @method('patch')
                    @csrf

                     <div class="form-group">
                       <label>Judul</label>
                       <input type="text" value="{{$ft->judul}}" name="judul" id="judul" class="form-control"/>
                    ...
                    <div class="form-group">
                       ...
                       <textarea class="summernote_dessription" name="deskripsi" id="">{{$ft->deskripsi}}</textarea>
                    </div>
