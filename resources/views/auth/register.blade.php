                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form action="{{route('register')}}" method="post" class="login-form">
                            ...
                            <br>
                            <div class="row mb-3 px-3"> <button type="submit" href="{{route('register')}}" class="btn btn-primary text-center">Register</button> </div>
                            <!-- <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a class="text-danger ">Register</a></small> </div> -->
                        </form>
                        <!-- <div class="row mb-3 px-3"> <button type="submit" class="btn btn-primary text-center">Register</button> </div> -->
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Sudah Ada Akun? <a class="text-danger ">Login</a></small> </div>
                    </div>
                </div>
            </div>
