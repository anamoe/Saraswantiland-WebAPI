...
<br><br>
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Edit Keuntungan Investasi</h5>
        ...
        <div class="modal-body">
            <form action="" id="updatemapel" method="post">
                ...
                <div class="form-group form-inline">
                    <label for="namamapel" class="col-md-3 col-form-label">Nama Keuntungan Investasi</label>
        ...
        <div class="col-md-12">
             <div class="px-3">
                <div class="card-header row">
                    <div class="col-md-12">
                        <span class="float-left" style="font-size: 24px;">Keuntungan Investasi</span>
                            ...
                            <tbody>
                             ...
                             @foreach($k as $p)
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('public/keuntungan_investasi/'.$p->foto)}}" alt="..." style=" height:50px; width:70px;"></td>
                                    <td>{{$p->judul}}</td>
                                    ...
                                    <a href="{{url('investasi/'.$p->id)}}" class="btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                    <a href="#" onclick="hapus('{{$p->id}}','{{$p->judul}}')"class="btn-sm btn-danger" onClick="hapus(this)" type="button" href="" data-target="#confirmation-modal"><i class="fa fa-trash"></i></a>
                                    </td>
        ...
        <div class="col-md-12  mt-5">
           <div class="card">
              <div class="card-header bg-primary">
                 <h6 class="text-white">Tambah Keuntungan Investasi <div style="cursor: pointer;" class="float-right kembalimateri">X</div> </h6>
              </div>
              <div class="card-body">
                 <form method="post" action="{{url('investasi')}}" enctype="multipart/form-data" id="submitdata">
                    @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <input type="file" onchange="readURLfoto(this);" class="d-none" name="image" accept="image/*"id="editfotoikhtisar"></input>
                    ...
                    <div class="form-group">
                       ...
                       <textarea class="form-control" name="deskripsi" id="isi_materi"></textarea>
                    </div>
...
function hapus(id,ruang) {
        ...
        $("#delete").attr("action","{{url('investasi')}}"+"/"+id)
        $("#hapus").modal("show")
    }
